    ...
    usleep(200000);
        ...
        // *************BOUCLE MODE DEMONTAGE
            while(1)
            {
                ...
                if((m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T1_Dem_Cap_Dep") == "0")) //TESTER en COMMENTAIRE
                {
                //********SCAN
                }
                ...
                if(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T1_Dem_Cap_Arr") == "1") //TESTER en COMMENTAIRE
                {
                //***********SCAN
                }
                ...
                if((m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T2_Dem_Cap_Dep") == "0")) //TESTER en COMMENTAIRE
                {
                //***********SCAN
                }
                ...
                if(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T2_Dem_Cap_Arr") == "1") //TESTER en COMMENTAIRE
                {
                //***********SCAN
                }
