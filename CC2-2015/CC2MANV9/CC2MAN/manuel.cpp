...

{
    ...
    QString	fileName3 =  "/home/cellflex-cc2/Bureau/CC2MAN V8/CC2MAN/csv/cellflex_vision.csv";
     ...
     pixmap.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/A1.png");
     pixmap = pixmap.scaled(this->piece1->size());

     pixmap2.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/B1.png");
     pixmap2 = pixmap2.scaled(this->piece2->size());

     pixmap3.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/C1.png");
     pixmap3 = pixmap3.scaled(this->piece3->size());

     pixmap4.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/D1.png");
     pixmap4 = pixmap4.scaled(this->piece3->size());

     pixmap5.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/E1.png");
     pixmap5 = pixmap5.scaled(this->piece3->size());

     pixmap6.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/A2.png");
     pixmap6 = pixmap6.scaled(this->piece3->size());

     pixmap7.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/B2.png");
     pixmap7 = pixmap7.scaled(this->piece3->size());

     pixmap8.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/C2.png");
     pixmap8 = pixmap8.scaled(this->piece3->size());

     pixmap9.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/D2.png");
     pixmap9 = pixmap9.scaled(this->piece3->size());

     pixmap10.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/E2.png");
     pixmap10 = pixmap10.scaled(this->piece3->size());

     pixmap11.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/A3.png");
     pixmap11 = pixmap11.scaled(this->piece3->size());

     pixmap12.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/B3.png");
     pixmap12 = pixmap12.scaled(this->piece3->size());

     pixmap13.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/C3.png");
     pixmap13 = pixmap13.scaled(this->piece3->size());

     pixmap14.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/D3.png");
     pixmap14 = pixmap14.scaled(this->piece3->size());

     pixmap15.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/E3.png");
     pixmap15 = pixmap15.scaled(this->piece3->size());

     pixmap16.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/A4.png");
     pixmap16 = pixmap16.scaled(this->piece3->size());

     pixmap17.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/B4.png");
     pixmap17 = pixmap17.scaled(this->piece3->size());

     pixmap18.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/C4.png");
     pixmap18 = pixmap18.scaled(this->piece3->size());

     pixmap19.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/D4.png");
     pixmap19 = pixmap19.scaled(this->piece3->size());

     pixmap20.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/E4.png");
     pixmap20 = pixmap20.scaled(this->piece3->size());

     pixmap21.load("/home/cellflex-cc2/Bureau/CC2MANV9/CC2MAN/ressources/A3.png");
     ...
     //scene->setSceneRect(this->piece1->rect());
     //scene2->setSceneRect(this->piece2->rect());
     //scene3->setSceneRect(this->piece3->rect());
...
void manuel::Transfert1AutoMon()
{
    ...
    if((m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T1_Mon_Cap_Dep") == "0"))
    {
    ...
    if(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T1_Mon_Cap_Arr") == "1")
    {
...
void manuel::Transfert2AutoMon()
{
    ...
    if(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T2_Mon_Cap_Arr") == "1")
    {
...
void manuel::Transfert1AutoDem()
{
    ...
    if((m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T1_Dem_Cap_Dep") == "0"))
    {
    ...
    if(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T1_Dem_Cap_Arr") == "1")
    {
...
void manuel::Transfert2AutoDem()
{
    ...
    if((m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T2_Dem_Cap_Dep") == "0"))
    {
    ...
    if(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T2_Dem_Cap_Arr") == "1")
    {
...
void manuel::Auto()
{
 ...
 piece_18->setEnabled( false), piece_19->setEnabled( false), piece_20->setEnabled( false);
    ...
    while(1)
{
    ...
    piece_20->setEnabled( true), pbuReadAll->setEnabled( false ), pbuAuto->setEnabled( false );
...
void manuel::tempsSysteme()
{

 temps->setTime(temps->time().addMSecs(1000)) ;
