...
void manuel::Moteur2()
{
    ...
    if(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "BT2_Dem_Mot") == "0" )
    {
        int i = 0 ;
        QamModbusMap::PrimaryTable table = QamModbusMap::HoldingRegister;
...
void manuel::Moteur1Dem()
{
    if(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "BT1_Dem_Mot") == "0" )
    {
        int i = 0 ;
        QamModbusMap::PrimaryTable table = QamModbusMap::HoldingRegister;
...
void manuel::TransfertVersT2()
{
    ...
    modeEnCours->setText("Transfert en cours...");
...
void manuel::TransfertVersT1()
{
    ...
    pbuVersT2Dem->setEnabled(true);
}


void manuel::TransfertVersT1Dem()
{
    int i = 0 ;
    QamModbusMap::PrimaryTable table = QamModbusMap::HoldingRegister;
    pbuVersT2->setEnabled(false);
    ...
    while(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T2_Dem_Cap_Arr") == "1")
    {
        m_modbusMap.at(i)->remoteValue( (QamModbusMap::PrimaryTable)table, "T2_Mon_Cap_Dep" ) ;
        m_modbusMap.at(i)->remoteValue( (QamModbusMap::PrimaryTable)table, "T2_Mon_Cap_Arr" ) ;
    }
...
void manuel::TransfertVersT2Dem()
{
    int i = 0 ;
    QamModbusMap::PrimaryTable table = QamModbusMap::HoldingRegister;
    pbuVersT1->setEnabled(false);
    ...
    while(m_modbusMap.at(0)->value(QamModbusMap::HoldingRegister, "T1_Dem_Cap_Arr") == "1")
    {
        m_modbusMap.at(i)->remoteValue( (QamModbusMap::PrimaryTable)table, "T1_Mon_Cap_Dep" ) ;
        m_modbusMap.at(i)->remoteValue( (QamModbusMap::PrimaryTable)table, "T1_Mon_Cap_Arr" ) ;
    }
...
void manuel::Reset()
{
    ...
    modeEnCours->setText("Arrêt rapide demandé...");
}
...
void manuel::ArretFinCycle()
{
    modeEnCours->setText("Arrêt fin de cycle\ndemandé...");
...
void manuel::traitement()
{

m_modbusMap.at(2)->setValue(QamModbusMap::Coil, "C_Mon", "1" );


while(m_modbusMap.at(2)->value(QamModbusMap::Coil, "C_Mon") == "1")
{
modeEnCours->setText("Traitement en cours...");
pbuTraitement->setEnabled(false);
}

if(m_modbusMap.at(2)->value(QamModbusMap::Coil, "C_Mon") == "0")
{


    QString j = m_modbusMap.at(2)->value(QamModbusMap::HoldingRegister, "C_Tab_Num");
    QString k = m_modbusMap.at(2)->value(QamModbusMap::HoldingRegister, "C_Tab_Ori");
    chaine1 = "/home/cellflex-cc2/Documents/CC2-2015/CC2MANV10+++/CC2MAN/ressources/";
    chaine3 = ".png";
    chaine4 = j;
    chaine5 = k;
    total2 = chaine1 + chaine4 + "," + chaine5 + chaine3;
    ...
    pbuTraitement->setEnabled(true);
    pbuDechargement->setEnabled(true);

    modeEnCours->setText("Mode Manuel en cours...");
    numeroPiece->setText("Pièce " + j);
    orientationPiece->setText("Orientation " + k);
...
void manuel::dechargement()
{

QString x = m_modbusMap.at(2)->value(QamModbusMap::HoldingRegister, "C_Tab_Num");
QString y = m_modbusMap.at(2)->value(QamModbusMap::HoldingRegister, "C_Tab_Ori");
m_modbusMap.at(1)->setValue(QamModbusMap::HoldingRegister, "D_Tab_Num", x );
m_modbusMap.at(1)->setValue(QamModbusMap::HoldingRegister, "D_Tab_Ori", y );
m_modbusMap.at(1)->setValue(QamModbusMap::Coil, "D_Mon", "1" );
pbuChargement->setEnabled(true);
}

void manuel::chargement()
{
QMessageBox::warning(this, "Attention !", "Aucune pièce ne dois se trouver sur la palette !");
