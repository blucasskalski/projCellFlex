...
public:
    ...
    int stop = 0;
    int stopcycle=0;
    int compteurPosteA=0;
    int compteurScara=0;
    int compteurVision=0;
    int progressBarre=0;
    bool scara = false;
    bool vision = false;
    bool attente = false;
    ...
    ,pixmap12,pixmap13,pixmap14,pixmap15,pixmap16,pixmap17,pixmap18,pixmap19,pixmap20,pixmap21,pixmap22,pixmap23;
    ...
    QGraphicsScene* scene21= new QGraphicsScene;
    QGraphicsScene* scene22= new QGraphicsScene;
    QGraphicsScene* scene23= new QGraphicsScene;

    QString chaine1 = "/home/cellflex-cc2/Documents/CC2-2015/CC2MANV10+++/CC2MAN/ressources/";
    QString chaine2 = numero[compteurVision];
    QString chaine3 = ".png";
    QString chaine4 = "";
    QString chaine5 = ",";
    QString total = chaine1 + chaine2 + chaine3;
    QString total2 = chaine1 + chaine4 + chaine3;
...
public slots:
  ...
  void TransfertVersT1Dem();
  void TransfertVersT2Dem();
  void Piece1();
  void Piece2();
  void Piece3();
  void Piece4();
