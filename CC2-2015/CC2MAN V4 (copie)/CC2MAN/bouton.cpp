...
void manuel::Moteur1()
{
    ...
    if(m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::HoldingRegister, "BT1_Mon_Mot") == "0" )
    {
        int i = tabWidget->currentIndex() ;
        QamModbusMap::PrimaryTable table = QamModbusMap::HoldingRegister;
...
void manuel::Moteur2()
{
    ...
    if(m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::HoldingRegister, "BT2_Mon_Mot") == "0" )
    {
        int i = tabWidget->currentIndex() ;
        QamModbusMap::PrimaryTable table = QamModbusMap::HoldingRegister;
...
void manuel::TransfertVersT2()
{
    ...
    while(m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::HoldingRegister, "T2_Mon_Cap_Arr") == "1")
    {
    ...
    if (m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::HoldingRegister, "T2_Mon_Cap_Arr") == "0")
{
...
void manuel::TransfertVersT1()
{
    ...
    while(m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::HoldingRegister, "T1_Mon_Cap_Arr") == "1")
    {
    ...
    if (m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::HoldingRegister, "T1_Mon_Cap_Arr") == "0")
{
...
void manuel::Piece1()
{
    ...
    while(((m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::Coil, "Axis_X_At_Pnt") == "0" ) && (m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::Coil, "Axis_Y_At_Pnt") == "0" )) ||
          ((m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::Coil, "Axis_X_At_Pnt") == "0" ) && (m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::Coil, "Axis_Y_At_Pnt") == "1" )) ||
          ((m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::Coil, "Axis_X_At_Pnt") == "1" ) && (m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::Coil, "Axis_Y_At_Pnt") == "0")))
    ...
    if((m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::Coil, "Axis_X_At_Pnt") == "1" ) && (m_modbusMap.at(tabWidget->currentIndex())->value(QamModbusMap::Coil, "Axis_Y_At_Pnt") == "1" ))
...
void manuel::Auto()
{
    ...
    if (m_modbusMap.at(i)->value(table, "E_Mon_Cap") == "1" ){
    m_modbusMap.at(i)->setValue(table, "E_But", "1" );
    }
    ...
    if (m_modbusMap.at(i)->value(table, "C_Mon_Cap") == "1" ){
    m_modbusMap.at(i)->setValue(table, "C_But", "1" );
    }
