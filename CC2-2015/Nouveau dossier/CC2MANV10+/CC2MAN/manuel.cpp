...

{
    ...
    QString	fileName3 =  "/home/cellflex-cc2/Bureau/CC2MAN V8/CC2MAN/csv/cellflex_vision.csv";
     ...
     pixmap10.load("/home/cellflex-cc2/Bureau/CC2MANV10+/CC2MAN/ressources/9.png");
...
void manuel::on_pbuConnect_clicked()
{
    ...
    if ( connected ) {
        ...
        pbuPom->setEnabled( false), pbuMoteur1->setEnabled( false ) ;
        pbuMoteur2->setEnabled( false ), pbuMonter->setEnabled( false ) ;
        ...
        pbuVersT2->setEnabled( false ), buteA->setEnabled( false ) ;
        ...
        if (( m_tcpCLient.at(index)->waitForConnected(3000) ) && ( m_tcpCLient.at(index2)->waitForConnected(3000) ) && ( m_tcpCLient.at(index3)->waitForConnected(3000) )){
            ...
            pbuMoteur1->setEnabled( true ), pbuMoteur2->setEnabled( true ) ;
            ...
            buteA->setEnabled( true ), buteS->setEnabled( true ) ;
...
void manuel::Auto()
{
 ...
 stop=0;
 compteurScara=0;
 compteurVision=0;//compteur vision
 stopcycle= 0;
 progressBarre=0;
