...
private:
  ...
  int position_x, position_y, position_h, position_w, bin1, bin2, blanc1,
      blanc2, nb_piece, rotation_piece, tempo, temps;
  quint32 line_1, line_2, line_vert_1, line_vert_2;
  quint64 grid;
  float densite_photo, tempo_densite;
  QString line_AS1, line_AS2, grid_AS, line_AS1_spe, grid_AS_spe, line_AS2_spe,
      line_vert_AS_1, line_vert_AS_2;
  QString line_vert_AS_1_spe, line_vert_AS_2_spe;
  QamImgHistogram *histogramme;
  // QamImgProcessor *traitement;
};

#define PATH_MODBUS_CSV                                                        \
  "$HOME/git/projCellFlex/projet-org/config/cellflex_vision.csv"
