...
QT_MOC_LITERAL(8, 59, 1) // "h"
    ...
    "mousePosition\0mouseRect\0w\0h"
};
...
void Qamgraphicsscene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Qamgraphicsscene::mousePoint)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Qamgraphicsscene::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Qamgraphicsscene::mousePosition)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Qamgraphicsscene::mouseRect)) {
                *result = 2;
                return;
            }
        }
