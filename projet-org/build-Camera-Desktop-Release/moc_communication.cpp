...
#include <memory>
#include "../Camera/communication.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Communication_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Communication_t qt_meta_stringdata_Communication = {
    {
        QT_MOC_LITERAL(0, 13),  // "Communication"
        QT_MOC_LITERAL(14, 16),  // "faire_traitement"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 5)   // "arret"
    },
    "Communication",
    "faire_traitement",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_Communication[] = {
...
Q_CONSTINIT const QMetaObject Communication::staticMetaObject = { {
    ...
    qt_meta_stringdata_Communication.offsetsAndSizes,
    qt_meta_data_Communication,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Communication_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Communication, std::true_type>,
        // method 'faire_traitement'
...
void Communication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->faire_traitement(); break;
        case 1: _t->arret(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Communication::faire_traitement; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Communication::faire_traitement()
{
