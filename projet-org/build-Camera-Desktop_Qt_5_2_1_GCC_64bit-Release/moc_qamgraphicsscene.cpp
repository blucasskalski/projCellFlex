...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Qamgraphicsscene_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 59, 1)
    },
    "Qamgraphicsscene\0mousePoint\0\0x\0y\0"
    "mousePosition\0mouseRect\0w\0h\0"
};
...
void Qamgraphicsscene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Qamgraphicsscene *_t = static_cast<Qamgraphicsscene *>(_o);
        switch (_id) {
        ...
        {
            typedef void (Qamgraphicsscene::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Qamgraphicsscene::mousePoint)) {
                *result = 0;
            }
        }
        {
            typedef void (Qamgraphicsscene::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Qamgraphicsscene::mousePosition)) {
                *result = 1;
            }
        }
        {
            typedef void (Qamgraphicsscene::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Qamgraphicsscene::mouseRect)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject Qamgraphicsscene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_Qamgraphicsscene.data,
      qt_meta_data_Qamgraphicsscene,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Qamgraphicsscene.stringdata))
        return static_cast<void*>(const_cast< Qamgraphicsscene*>(this));
