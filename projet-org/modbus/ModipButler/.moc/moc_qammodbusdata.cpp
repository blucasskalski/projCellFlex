...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QamModbusData_t, stringdata0) + ofs), len 
...
void QamModbusData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QamModbusData::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QamModbusData::staticMetaObject = { {
    ...
    qt_meta_stringdata_QamModbusData.offsetsAndSize,
    qt_meta_data_QamModbusData,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QamModbusData_t
, QtPrivate::TypeAndForceComplete<QamModbusData, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const QString &, std::false_type>
