...
#include <memory>
#include "../../ModipMap/qammodbusmap.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QamModbusMap_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QamModbusMap_t qt_meta_stringdata_QamModbusMap = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QamModbusMap[] = {
...
Q_CONSTINIT const QMetaObject QamModbusMap::staticMetaObject = { {
    QMetaObject::SuperData::link<QamAbstractServer::staticMetaObject>(),
    qt_meta_stringdata_QamModbusMap.offsetsAndSizes,
    qt_meta_data_QamModbusMap,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QamModbusMap_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QamModbusMap, std::true_type>,
        // method 'responseDone'
        ...
        // method 'setValue'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<PrimaryTable, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
...
void QamModbusMap::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QamModbusMap::responseDone; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QamModbusMap::valueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QamModbusMap::info; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
