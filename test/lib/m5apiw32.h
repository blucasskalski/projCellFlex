...
#define STATEID_MOD_OVERSHOOT						0x10000000L
#define STATEID_MOD_UNDERSHOOT					0x20000000L
...
// ---- PID LOOP SETUPS -------------
#define SETUPID_MOD_PIDVELFF_LOOP						0x00100000L
#define SETUPID_MOD_PD_LOOP									0x00200000L

#define SETUPID_MOD_USE_BLOCK_COM					0x00000080L
// ---- ELECTRONIC GEAR -------------
#define SETUPID_MOD_MASTER_DRIVE						0x00000100L
#define SETUPID_MOD_SLAVE_DRIVE							0x00400000L //Ab 46xx
#define SETUPID_MOD_SAVELASTKNOWNPOS    0x00000002L
//-----------------------------------------------------------------------
...
M5DLL_API int WINAPI PCube_getMaxMotorCurGradient( int iDeviceId, int iModuleId, float* pfValue );
M5DLL_API int WINAPI PCube_setMaxMotorCurGradient( int iDeviceId, int iModuleId, float fValue );
M5DLL_API int WINAPI PCube_getMaxTemperature( int iDeviceId, int iModuleId, float* pfValue );
M5DLL_API int WINAPI PCube_setMaxTemperature( int iDeviceId, int iModuleId, float fValue );
M5DLL_API int WINAPI PCube_getMinTemperature( int iDeviceId, int iModuleId, float* pfValue );
M5DLL_API int WINAPI PCube_setMinTemperature( int iDeviceId, int iModuleId, float fValue );

M5DLL_API int WINAPI PCube_getKpPIDvFF( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getKiPIDvFF( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getKdPIDvFF( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getIntLimPIDvFF( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getKvffPIDvFF( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getBiasPIDvFF( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getIntPIDvFF( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getLeadAngle( int iDeviceId, int iModuleId, unsigned char* pucValue );
M5DLL_API int WINAPI PCube_getModuleSize( int iDeviceId, int iModuleId, float* piValue );
M5DLL_API int WINAPI PCube_getKpPD( int iDeviceId, int iModuleId, unsigned long* puiValue );
M5DLL_API int WINAPI PCube_getKdPD( int iDeviceId, int iModuleId, unsigned long* puiValue );
M5DLL_API int WINAPI PCube_getThetaMin( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getThetaMax( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getThetaPMax( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getUmax( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getKModelInt( int iDeviceId, int iModuleId, unsigned long* puiValue );
M5DLL_API int WINAPI PCube_getLModelInt( int iDeviceId, int iModuleId, unsigned long* puiValue );
M5DLL_API int WINAPI PCube_getKRTInt( int iDeviceId, int iModuleId, unsigned short* puiValue );
M5DLL_API int WINAPI PCube_getMaxTempInt( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_getMaxCurInt( int iDeviceId, int iModuleId, unsigned short* puiValue );
M5DLL_API int WINAPI PCube_getIPolOrder( int iDeviceId, int iModuleId, unsigned short* puiValue );
M5DLL_API int WINAPI PCube_getSimTemp( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_setKpPIDvFF( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setKiPIDvFF( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setKdPIDvFF( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setIntLimPIDvFF( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setKvffPIDvFF( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setBiasPIDvFF( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setLeadAngle( int iDeviceId, int iModuleId, unsigned char uiValue );
M5DLL_API int WINAPI PCube_setModuleSize( int iDeviceId, int iModuleId, float iValue );
M5DLL_API int WINAPI PCube_setKpPD( int iDeviceId, int iModuleId, unsigned long iValue );
M5DLL_API int WINAPI PCube_setKdPD( int iDeviceId, int iModuleId, unsigned long iValue );
M5DLL_API int WINAPI PCube_setThetaMin( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setThetaMax( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setThetaPMax( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setUmax( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setKModelInt( int iDeviceId, int iModuleId, unsigned long iValue );
M5DLL_API int WINAPI PCube_setLModelInt( int iDeviceId, int iModuleId, unsigned long iValue );
M5DLL_API int WINAPI PCube_setKRTInt( int iDeviceId, int iModuleId, unsigned short iValue );
M5DLL_API int WINAPI PCube_setMaxTempInt( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_setMaxCurInt( int iDeviceId, int iModuleId, unsigned short iValue );
M5DLL_API int WINAPI PCube_setIPolOrder( int iDeviceId, int iModuleId, unsigned short iValue );

M5DLL_API int WINAPI PCube_getUmin( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_setUmin( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_getKpPowerLimiter( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_setKpPowerLimiter( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_getMinVoltagePowerLimiter( int iDeviceId, int iModuleId, float* pfValue );
M5DLL_API int WINAPI PCube_setMinVoltagePowerLimiter( int iDeviceId, int iModuleId, float fValue );

M5DLL_API int WINAPI PCube_softStopAll( int iDeviceId );
M5DLL_API int WINAPI PCube_softStopModule( int iDeviceId, int iModuleId );
M5DLL_API int WINAPI PCube_getIPolVelInc( int iDeviceId, int iModuleId, long* piValue );

M5DLL_API int WINAPI PCube_getCommTimeOut( int iDeviceId, int iModuleId, long* piValue );
M5DLL_API int WINAPI PCube_setCommTimeOut( int iDeviceId, int iModuleId, long iValue );

M5DLL_API int WINAPI PCube_getPosTime( int iDeviceId, int iModuleId, float* pfValue, unsigned short* pTime );
M5DLL_API int WINAPI PCube_resetTime( int iDeviceId, int iModuleId );
M5DLL_API int WINAPI PCube_moveCosLoop( int iDeviceId, int iModuleId, float fValue, long lValue );
M5DLL_API int WINAPI PCube_moveRampLoop( int iDeviceId, int iModuleId, float fValue );
M5DLL_API int WINAPI PCube_resetTimeAll( int iDeviceId );

M5DLL_API int WINAPI PCube_setDefCurOffset( int iDeviceId, int iModuleId, float fValue );
M5DLL_API int WINAPI PCube_getDefAddress( int iDeviceId, int iModuleId, unsigned char* pucValue );
