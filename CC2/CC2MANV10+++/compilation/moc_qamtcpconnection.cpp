...
#include "../../../Documents/CC2-2015/CC2MANV10+++/CC2MAN/ModipTcp/qamtcpconnection.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QamTcpConnection_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 28, 12)
    ...
    "QamTcpConnection\0readyRead\0\0disconnected\0"
};
...
void QamTcpConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QamTcpConnection *_t = static_cast<QamTcpConnection *>(_o);
        switch (_id) {
...
const QMetaObject QamTcpConnection::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QamTcpConnection.data,
      qt_meta_data_QamTcpConnection,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QamTcpConnection.stringdata))
        return static_cast<void*>(const_cast< QamTcpConnection*>(this));
