...
#include "../../../Documents/CC2-2015/CC2MANV10+++/CC2MAN/ModipTcp/qamtcpclient.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QamTcpClient_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 79, 28),
QT_MOC_LITERAL(10, 108, 5),
QT_MOC_LITERAL(11, 114, 13),
QT_MOC_LITERAL(12, 128, 16)
    },
    "QamTcpClient\0sockReceive\0\0sockInfo\0"
    "sockClose\0sockWrite\0data\0sockRead\0"
    "sockError\0QAbstractSocket::SocketError\0"
    "error\0sockConnected\0sockDisconnected\0"
};
...
void QamTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QamTcpClient::sockReceive)) {
                *result = 0;
            }
        }
        {
...
const QMetaObject QamTcpClient::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_QamTcpClient.data,
      qt_meta_data_QamTcpClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QamTcpClient.stringdata))
