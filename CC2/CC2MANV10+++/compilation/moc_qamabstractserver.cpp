...
#include "../../../Documents/CC2-2015/CC2MANV10+++/CC2MAN/ModipTcp/qamabstractserver.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QamAbstractServer_t, stringdata) + ofs \
...
const QMetaObject QamAbstractServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QamAbstractServer.data,
      qt_meta_data_QamAbstractServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QamAbstractServer.stringdata))
