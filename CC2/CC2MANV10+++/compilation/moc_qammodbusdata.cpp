...
#include "../../../Documents/CC2-2015/CC2MANV10+++/CC2MAN/ModipMap/qammodbusdata.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QamModbusData_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 28, 4)
    ...
    "QamModbusData\0valueChanged\0\0name\0"
};
...
const QMetaObject QamModbusData::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QamModbusData.data,
      qt_meta_data_QamModbusData,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QamModbusData.stringdata))
