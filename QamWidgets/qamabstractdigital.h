/*  ---------------------------------------------------------------------------
 *  nom         :   qamabstractdigital.h
 *  
 *  description :   INTERFACE classe de base abstraite QamAbstractDigital
 *  				
 *  création    :   jan 2004
 *  version     :   4.5
 *  maj			:	09/03/2012
...
#endif
{
  ...
  public :
	...
	bool	isGradient() const ;			// obsolète
	void	setGradient(bool gradient ) ;	// obsolète
