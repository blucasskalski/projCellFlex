...
#define QAMANALOGMETER_VERSION	"1.0"

#include "qamanalogmeter.h"
#include <QPainter>
#include <math.h>

QString QamAnalogMeter::version() { return QString( QAMANALOGMETER_VERSION ) ; }
...
// dessin du widget avec aiguille et valeur

void QamAnalogMeter::paintEvent(QPaintEvent* /*pe*/ )
{
	showBackground() ;
