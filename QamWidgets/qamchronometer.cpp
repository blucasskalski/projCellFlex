...
#define QAMCHRONOMETER_VERSION	"1.1"

#include "qamchronometer.h"

QString QamChronoMeter::version() { return QString( QAMCHRONOMETER_VERSION ) ; }
...
//	m_value = QTime(0,0) ;
//	m_inc = true ;
//	m_inc = ( m_value.isNull() ? true : false ) ;
    m_inc = ( m_value == QTime(0,0) ? true : false ) ;  // modif. 14/12/12
    m_pause = false ;
	m_it->start( m_period ) ;
}
